...
/**
 * A Linked Structure implementaton of the <tt>BinaryTree</tt> interface.
 */
public class LinkedBinaryTree<E> implements BinaryTree<E> {
  ...
  /**
   * Create a <tt>BinaryTree</tt> with <tt>element</tt> stored in its root. The
   * tree must be empty to be able to make a root for it.
   * 
  ...
  /**
   * Create a <tt>BinaryTree</tt> with <tt>node</tt> at the root.
   * 
   * @throws TreeException if the tree is not empty
   */
  ...
  /**
   * Create a <tt>BinaryTree</tt> with <tt>element</tt> stored in the root and
   * <tt>leftTree</tt> and <tt>rightTree</tt> as its left and right children.
   * 
  ...
  public LinkedBinaryTree(BinaryTree<E> leftTree, E element,
    ...
    if (leftTree != null) {
      ...
      this.root.leftChild = (LinkedBinaryTreeNode<E>) ((LinkedBinaryTree<E>) leftTree)
              .root();
    ...
    if (rightTree != null) {
      ...
      this.root.rightChild = (LinkedBinaryTreeNode<E>) ((LinkedBinaryTree<E>) rightTree)
              .root();
  ...
  // ******************* MUTATOR METHODS
  /**
   * Create a node to store <tt>element</tt> and make it the root of the tree
   * 
   * @param element the element to store in the root of this tree
  ...
  /**
   * Create a node in the tree to store <tt>element</tt> and make it the left
   * child of <tt>parent</tt>. The parent must not be null and may not already
   * have a left child.
   * 
   ...
   * @throws TreeException if <tt>parent</tt> is null or has a left child.
   */
  public BinaryTreeNode<E> makeLeftChild(
    ...
    LinkedBinaryTreeNode<E> lchild = new LinkedBinaryTreeNode<E>(element);
  ...
  /**
   * Create a node in the tree to store <tt>element</tt> and make it the right
   * child of <tt>parent</tt>. The parent must not be null and may not already
   * have a right child.
   * 
   * @param parent  the parent of the node to be added
   ...
   * @throws TreeException if <tt>parent</tt> is null or has a right child.
   */
  public BinaryTreeNode<E> makeRightChild(
    ...
    LinkedBinaryTreeNode<E> rchild = new LinkedBinaryTreeNode<E>(element);
  ...
  /**
   * Remove the specified node from the tree. In this implementation, the node
   * is replaced by a leaf descendant.
   * 
  ...
  public void remove(BinaryTreeNode<E> target) {
    ...
    LinkedBinaryTreeNode<E> node = (LinkedBinaryTreeNode<E>) target;
  ...
  /**
   * Get a descendant of node that is a leaf. Preference is for the rightmost
   * child, but we'll go left if we have to.
   * 
  ...
  /**
   * Look for <tt>target</tt> in this tree. If it is found, return the
   * <tt>BinaryTreeNode</tt> that contains it, else return <tt>null</tt>. Uses
   * <tt>equals()</tt> to compare the target against object stored in this tree.
   * 
   * @param target the element we wish to find.
   * @return <tt>true</tt> if <tt>target</tt> if found in this tree,
  ...
  /**
   * Return the number of nodes in this <tt>BinaryTree</tt>. If this tree
   * contains more than <tt>Integer.MAX_VALUE</tt> nodes, returns
  ...
  // ******************* TRAVERSAL METHODS
  /**
   * Perform a pre order traversal of this tree applying the Visitor to each
   * node.
   * 
   * @param visitor the <tt>Visitor</tt> object to apply during the traversal
   */
  ...
  /**
   * Perform an in order traversal of this tree applying the Visitor to each
   * node.
   * 
   * @param visitor the <tt>Visitor</tt> object to apply during the traversal
   */
  ...
  /**
   * Perform a post order traversal of this tree applying the Visitor to each
   * node.
   * 
   * @param visitor the <tt>Visitor</tt> object to apply during the traversal
   */
  ...
  /**
   * Perform a level order traversal of this tree applying the Visitor to each
   * node.
   * 
   * @param visitor the <tt>Visitor</tt> object to apply during the traversal
   */
  public void levelOrderTraversal(Visitor<E> visitor) {
    ...
    Queue<BinaryTreeNode<E>> nodeQueue = new CircularQueue<BinaryTreeNode<E>>();
  ...
  /**
   * The recursive method for doing a preorder traversal of the tree rooted at
  ...
  /**
   * The recursive method for doing an inorder traversal of the tree rooted at
   * node, applying visitor to each node of the tree.
   * 
   * @param node    is not null (no check done)
   * @param visitor is not null (no check done)
  ...
  /**
   * The recursive method for doing a postorder traversal of the tree rooted at
   * node, applying visitor to each node of the tree.
   * 
   * @param node    is not null (no check done)
   * @param visitor is not null (no check done)
