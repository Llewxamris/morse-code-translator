...
public interface BinaryTreeNode<E> {
  ...
  /**
   * Set this <tt>BinaryTreeNode</tt>'s element to store the argument.
   * 
  ...
  /**
   * Determine if this node is an internal node (has a child). By inverting the
   * test, this method can be used to determine if this node is an external node
   * (leaf).
   * 
